...
const platformPackageNames = {
  "darwin-arm64": "@quantex/agx-darwin-arm64",
  "darwin-x64": "@quantex/agx-darwin-x64",
  "linux-arm64": "@quantex/agx-linux-arm64",
  "linux-x64": "@quantex/agx-linux-x64",
  "win32-arm64": "@quantex/agx-win32-arm64",
  "win32-x64": "@quantex/agx-win32-x64"
};
...
function resolveBinary() {
  ...
  throw new Error(
    `No AGX native binary found for ${key}. Reinstall @quantex/agx or set AGX_BINARY_PATH.`
  );
}
