...
- AND structured upgrade results expose only the stable quantex-compatible field set
- AND `recoveryHint` is emitted only for `manual-required` upgrade outcomes
